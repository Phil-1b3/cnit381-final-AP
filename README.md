...
# Our verify connections playbook will use commands show connectivity and versions.
...
# Our backup playbook will replicate the running configs into .cfg files in our backups folder.
